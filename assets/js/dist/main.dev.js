...
var map = L.map('map').setView([40.64740434388478, -73.9088304023876], 15);
...
L.marker([40.64740434388478, -73.9088304023876], {
  icon: myIcon
}).addTo(map).bindPopup('POP UP'); // Stadia_AlidadeSmooth = L.tileLayer('https://tiles.stadiamaps.com/tiles/alidade_smooth/{z}/{x}/{y}{r}.png', {
//     maxZoom: 20,
